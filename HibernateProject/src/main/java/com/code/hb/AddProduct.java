...
public class AddProduct {
    ...
    public AddProduct(SessionFactory sessionFactory) {
        ...
        try {
            ...
            // Create products
            Product product1 = new Product("Smartphone", BigDecimal.valueOf(499.99), 50, category1);
            session.persist(product1);

            Product product2 = new Product("Laptop", BigDecimal.valueOf(899.99), 30, category1);
            session.persist(product2);

            Product product3 = new Product("T-shirt", BigDecimal.valueOf(19.99), 100, category2);
